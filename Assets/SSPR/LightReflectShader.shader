...
Shader "URP/LightReflectShader"
{
    Properties
    {
        ...
        //SSPR Roughness Reflect
        _Roughness("SSPR Roughness",Range(0,1))=0
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            half4 frag(Varyings i): SV_Target
            {
                ...
                half3 RefCol = SAMPLE_TEXTURE2D(_SSPRReflectionTexture,sampler_SSPRReflectionTexture,suv)*_RefColor;
                diffuse = lerp(diffuse,RefCol,_Roughness);
                // 计算其他光源与阴影
