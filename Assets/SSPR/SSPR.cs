...
namespace SSPR{
    ...
    public class SSPR : ScriptableRendererFeature{
        ...
        private const string mComputeShaderName = "SSPRShader";
        ...
        class SSPRPass : ScriptableRenderPass{
            ...
            private string mSSPRKernelName = "CSMain",
            ...
            private static readonly int mReflectPlaneHeihgtID = Shader.PropertyToID("_ReflectPlaneHeight"),
            ...
            public override void OnCameraSetup(CommandBuffer cmd, ref RenderingData renderingData) {
                ...
                mComputeShader.SetFloat(mReflectPlaneHeihgtID, mSettings.ReflectHeight);
