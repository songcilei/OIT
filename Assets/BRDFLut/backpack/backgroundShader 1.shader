Shader "Custom/URP/backgroundShader 1"
{
    Properties
    {
        ...
        _Roughness("RoughnessTex",2D)="white"{}
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            half4 frag(Varyings input) : SV_Target
            {
                ...
                // return float4(inputData.normalWS.xyz,1);
                ...
                surfaceData.smoothness = _Smoothness*(1-SAMPLE_TEXTURE2D(_Roughness,sampler_Roughness,input.uv).r);
